...
*En este ejemplo, la función `valorExiste` recibe un array de enteros, su tamaño y el valor que se desea buscar. Itera sobre el array y compara cada elemento con el valor buscado. Si encuentra el valor, retorna 1, de lo contrario, retorna 0. Luego, en la función `main`, se llama a esta función para verificar si un valor específico existe en el array `numeros`.*
